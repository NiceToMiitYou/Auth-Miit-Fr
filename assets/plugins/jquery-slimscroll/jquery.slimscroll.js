        ...
        slimScroll: function( n ) {
            ...
            this.each( function() {
                ...
                function a() {
                    ...
                    g = m;
                    v >= w.outerHeight() ? b = !0 : ( S.stop( !0, !0 )
                        .fadeIn( "fast" ), r.railVisible && x.stop( !0, !0 )
                        .fadeIn( "fast" ) )
                }
                ...
                if ( w.parent()
                    ...
                    r.height = "auto" == r.height ? w.parent()
                        .height() : r.height;
                    E = e( "<div></div>" )
                    ...
                    } ), s( 0, !0 ) ) : "top" !== r.start && ( s( e( r.start )
                        .position()
                        .top, null, !0 ), r.alwaysVisible || S.hide() );
                    o()
                }
            } );
            return this
