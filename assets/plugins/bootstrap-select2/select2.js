...
( function( $, undefined ) {
    ...
    function markMatch( text, term, markup, escapeMarkup ) {
        var match = stripDiacritics( text.toUpperCase() )
            .indexOf( stripDiacritics( term.toUpperCase() ) ),
            tl = term.length;
    ...
    AbstractSelect2 = clazz( Object, {
        ...
        getPlaceholderOption: function() {
            if ( this.select ) {
                var firstOption = this.select.children()
                    .first();
    ...
    MultiSelect2 = clazz( AbstractSelect2, {
        ...
        postprocessResults: function( data, initial, noHighlightUpdate ) {
            ...
            if ( !this.opts.createSearchChoice && !choices.filter( '.select2-result:not(.select2-selected)' )
                .length > 0 ) {
                if ( !data || data && !data.more && this.results.find( ".select2-no-results" )
                    .length === 0 ) {
